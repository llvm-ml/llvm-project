...
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[TMP4:%.*]] = call ptr @__instrumentor_post_base_pointer(ptr [[A]])
; CHECK-NEXT:    [[STOREDV:%.*]] = zext i1 [[VAL]] to i8
; CHECK-NEXT:    [[TMP0:%.*]] = zext i8 [[STOREDV]] to i64
; CHECK-NEXT:    [[TMP5:%.*]] = call ptr @__instrumentor_pre_store(ptr [[A]], i32 0, i64 [[TMP0]], i64 8, i32 12, i64 1, i32 0, i8 1, i8 0, ptr [[TMP4]])
; CHECK-NEXT:    store i8 [[STOREDV]], ptr [[TMP5]], align 1
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 1
; CHECK-NEXT:    [[TMP3:%.*]] = call ptr @__instrumentor_pre_load(ptr [[ARRAYIDX]], i32 0, i64 1, i32 12, i64 1, i32 0, i8 1, i8 0, ptr [[TMP4]])
; CHECK-NEXT:    [[TMP1:%.*]] = load i8, ptr [[TMP3]], align 1
; CHECK-NEXT:    [[TMP2:%.*]] = zext i8 [[TMP1]] to i64
; CHECK-NEXT:    [[TMP6:%.*]] = call i64 @__instrumentor_post_load(ptr [[TMP3]], i32 0, i64 [[TMP2]], i64 1, i32 12, i64 1, i32 0, i8 1, i8 0, ptr null)
...
; CHECK-NEXT:    [[TMP5:%.*]] = call ptr @__instrumentor_pre_store(ptr [[A]], i32 0, i64 [[TMP0]], i64 16, i32 12, i64 2, i32 0, i8 1, i8 0, ptr [[TMP4]])
; CHECK-NEXT:    store i16 [[VAL]], ptr [[TMP5]], align 2
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 2
; CHECK-NEXT:    [[TMP3:%.*]] = call ptr @__instrumentor_pre_load(ptr [[ARRAYIDX]], i32 0, i64 2, i32 12, i64 2, i32 0, i8 1, i8 0, ptr [[TMP4]])
; CHECK-NEXT:    [[TMP1:%.*]] = load i16, ptr [[TMP3]], align 2
; CHECK-NEXT:    [[TMP2:%.*]] = zext i16 [[TMP1]] to i64
; CHECK-NEXT:    [[TMP6:%.*]] = call i64 @__instrumentor_post_load(ptr [[TMP3]], i32 0, i64 [[TMP2]], i64 2, i32 12, i64 2, i32 0, i8 1, i8 0, ptr null)
...
; CHECK-NEXT:    [[TMP5:%.*]] = call ptr @__instrumentor_pre_store(ptr [[A]], i32 0, i64 [[TMP0]], i64 32, i32 12, i64 4, i32 0, i8 1, i8 0, ptr [[TMP4]])
; CHECK-NEXT:    store i32 [[VAL]], ptr [[TMP5]], align 4
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 4
; CHECK-NEXT:    [[TMP3:%.*]] = call ptr @__instrumentor_pre_load(ptr [[ARRAYIDX]], i32 0, i64 4, i32 12, i64 4, i32 0, i8 1, i8 0, ptr [[TMP4]])
; CHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr [[TMP3]], align 4
; CHECK-NEXT:    [[TMP2:%.*]] = zext i32 [[TMP1]] to i64
; CHECK-NEXT:    [[TMP6:%.*]] = call i64 @__instrumentor_post_load(ptr [[TMP3]], i32 0, i64 [[TMP2]], i64 4, i32 12, i64 4, i32 0, i8 1, i8 0, ptr null)
...
; CHECK-NEXT:    [[TMP1:%.*]] = call ptr @__instrumentor_pre_store(ptr [[A]], i32 0, i64 [[VAL]], i64 64, i32 12, i64 8, i32 0, i8 1, i8 0, ptr [[TMP0]])
...
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[TMP0:%.*]] = call ptr @__instrumentor_post_base_pointer(ptr [[A]])
; CHECK-NEXT:    [[TMP4:%.*]] = trunc i128 [[VAL]] to i64
; CHECK-NEXT:    [[TMP5:%.*]] = call ptr @__instrumentor_pre_store(ptr [[A]], i32 0, i64 [[TMP4]], i64 128, i32 12, i64 8, i32 0, i8 1, i8 0, ptr [[TMP0]])
; CHECK-NEXT:    store i128 [[VAL]], ptr [[TMP5]], align 8
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 16
; CHECK-NEXT:    [[TMP3:%.*]] = call ptr @__instrumentor_pre_load(ptr [[ARRAYIDX]], i32 0, i64 16, i32 12, i64 8, i32 0, i8 1, i8 0, ptr [[TMP0]])
; CHECK-NEXT:    [[TMP1:%.*]] = load i128, ptr [[TMP3]], align 8
; CHECK-NEXT:    [[TMP7:%.*]] = trunc i128 [[TMP1]] to i64
; CHECK-NEXT:    [[TMP6:%.*]] = call i64 @__instrumentor_post_load(ptr [[TMP3]], i32 0, i64 [[TMP7]], i64 16, i32 12, i64 8, i32 0, i8 1, i8 0, ptr null)
...
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[TMP5:%.*]] = call ptr @__instrumentor_post_base_pointer(ptr [[A]])
; CHECK-NEXT:    [[TMP0:%.*]] = bitcast float [[VAL]] to i32
; CHECK-NEXT:    [[TMP1:%.*]] = zext i32 [[TMP0]] to i64
; CHECK-NEXT:    [[TMP6:%.*]] = call ptr @__instrumentor_pre_store(ptr [[A]], i32 0, i64 [[TMP1]], i64 32, i32 2, i64 4, i32 0, i8 1, i8 0, ptr [[TMP5]])
; CHECK-NEXT:    store float [[VAL]], ptr [[TMP6]], align 4
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 4
; CHECK-NEXT:    [[TMP7:%.*]] = call ptr @__instrumentor_pre_load(ptr [[ARRAYIDX]], i32 0, i64 4, i32 2, i64 4, i32 0, i8 1, i8 0, ptr [[TMP5]])
; CHECK-NEXT:    [[TMP2:%.*]] = load float, ptr [[TMP7]], align 4
; CHECK-NEXT:    [[TMP3:%.*]] = bitcast float [[TMP2]] to i32
; CHECK-NEXT:    [[TMP4:%.*]] = zext i32 [[TMP3]] to i64
; CHECK-NEXT:    [[TMP8:%.*]] = call i64 @__instrumentor_post_load(ptr [[TMP7]], i32 0, i64 [[TMP4]], i64 4, i32 2, i64 4, i32 0, i8 1, i8 0, ptr null)
...
; CHECK-NEXT:    [[TMP5:%.*]] = call ptr @__instrumentor_pre_store(ptr [[A]], i32 0, i64 [[TMP0]], i64 64, i32 3, i64 8, i32 0, i8 1, i8 0, ptr [[TMP4]])
; CHECK-NEXT:    store double [[VAL]], ptr [[TMP5]], align 8
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 8
; CHECK-NEXT:    [[TMP3:%.*]] = call ptr @__instrumentor_pre_load(ptr [[ARRAYIDX]], i32 0, i64 8, i32 3, i64 8, i32 0, i8 1, i8 0, ptr [[TMP4]])
; CHECK-NEXT:    [[TMP1:%.*]] = load double, ptr [[TMP3]], align 8
; CHECK-NEXT:    [[TMP2:%.*]] = bitcast double [[TMP1]] to i64
; CHECK-NEXT:    [[TMP6:%.*]] = call i64 @__instrumentor_post_load(ptr [[TMP3]], i32 0, i64 [[TMP2]], i64 8, i32 3, i64 8, i32 0, i8 1, i8 0, ptr null)
; CHECK-NEXT:    [[TMP7:%.*]] = bitcast i64 [[TMP6]] to double
...
; CHECK-NEXT:    [[TMP5:%.*]] = call ptr @__instrumentor_pre_store_ind(ptr [[A]], i32 0, ptr [[TMP0]], i64 80, i32 4, i64 16, i32 0, i8 1, i8 0, ptr [[TMP4]])
; CHECK-NEXT:    store x86_fp80 [[VAL]], ptr [[TMP5]], align 16
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 16
; CHECK-NEXT:    [[TMP3:%.*]] = call ptr @__instrumentor_pre_load(ptr [[ARRAYIDX]], i32 0, i64 10, i32 4, i64 16, i32 0, i8 1, i8 0, ptr [[TMP4]])
